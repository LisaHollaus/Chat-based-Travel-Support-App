...
class ClientHelper(object):
    ...
    def get_attraction_details_loop(self, s, traveller = False): # s is the socket and traveller is an optional parameter to give the traveller the option to add the attraction to the faviorites list
        while True:
            ...
            # option to add attraction to favirites list if traveller is logged in
